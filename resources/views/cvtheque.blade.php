          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active open">
              <a href="{{ url('/') }}" class="menu-link menu-toggle">
                ...
                <div class="text-truncate" data-i18n="Dashboard">Administration</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item active">
                  <a href="{{ url('/competences') }}" class="menu-link">
                    <div class="text-truncate" data-i18n="Competences">Compétences</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a
                    href="{{ url('/metiers') }}"
                    class="menu-link">
                    <div class="text-truncate" data-i18n="Metiers">Métiers</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a
                    ...
                    class="menu-link">
                    <div class="text-truncate" data-i18n="xxx">Professionnels</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a
                    href="#"
                    class="menu-link">
                    <div class="text-truncate" data-i18n="xxx">xxx</div>
                  </a>
                </li>
                <li class="menu-item">
